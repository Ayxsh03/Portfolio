...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Ayxsh03", label: "GitHub" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/ayush-sai-317528300/", label: "LinkedIn" },
    { icon: Mail, href: "mailto:ayxshsai@gmail.com", label: "Email" }
  ];
